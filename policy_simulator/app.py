# app3bc_v2.py - User-friendly version with clear explanations (Fixed Settings: no sidebar)
...
# Optional MI (can be toggled in code)
...
# ──────────────────────────────
# FIXED ANALYSIS SETTINGS (no sidebar)
# ──────────────────────────────
logC = -2.50   # Simplicity Level (fixed)
l1r  = 0.80    # Focus Level (fixed)
use_mi = False # Uncertainty analysis disabled by default
m_runs = 5     # Placeholder; used only if use_mi=True
...
# ──────────────────────────────
# Optional: MULTIPLE IMPUTATION (disabled by default)
# ──────────────────────────────
@st.cache_resource
